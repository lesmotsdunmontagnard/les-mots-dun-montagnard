...
import {metadata,selectPoems} from '../assets/catalogue.js';
...
export function build({demo=false}={}) {
  ...
  let poems = loadEntries('poemes.json'), news = loadEntries('actualites.json');
  if (demo) {
